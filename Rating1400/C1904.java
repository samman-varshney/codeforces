...
public class C1904 {
    ...
    public static int lowerBound(long[] nums, long val) {
        int start = 0, end = nums.length - 1;
        while (start <= end) {
            int mid = start + (end - start) / 2;
            if (nums[mid] <= val) {
    ...
    public static <T extends Comparable<? super T>> int lowerBound(List<T> nums, T val) {
        int start = 0, end = nums.size() - 1;
        while (start <= end) {
            int mid = start + (end - start) / 2;
            if (nums.get(mid).compareTo(val) <= 0) {
                start = mid + 1;
            } else {
                end = mid - 1;
            }
    ...
    public static <T extends Comparable<? super T>> int lowerBound(T[] nums, T val) {
        int start = 0, end = nums.length - 1;
        while (start <= end) {
            int mid = start + (end - start) / 2;
            if (nums[mid].compareTo(val) <= 0) {
                start = mid + 1;
            } else {
                end = mid - 1;
            }
    ...
    public static int upperBound(long[] nums, long val) {
        int start = 0, end = nums.length - 1;
        while (start <= end) {
            int mid = start + (end - start) / 2;
            if (nums[mid] >= val) {
    ...
    public static <T extends Comparable<? super T>> int upperBound(T[] nums, T val) {
        int start = 0, end = nums.length - 1;
        while (start <= end) {
            int mid = start + (end - start) / 2;
            if (nums[mid].compareTo(val) >= 0) {
    ...
    public static <T extends Comparable<? super T>> int upperBound(List<T> nums, T val) {
        int start = 0, end = nums.size() - 1;
        while (start <= end) {
            int mid = start + (end - start) / 2;
            if (nums.get(mid).compareTo(val) >= 0) {
    ...
    public static void helper() throws IOException {
        ...
        for (long temp : diff) {
            int upper = upperBound(nums, temp);
            int lower = lowerBound(nums, temp);

            if (upper >= 0 && upper <= n) {
                min = min(min, nums[upper] - temp);
            }

            if (lower >= 0 && lower < n) {
                min = min(min, temp - nums[lower]);
            }
